# Generated by Django 3.2.9 on 2022-02-03 11:10
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.ManyToManyField(related_name='posts', to='app_blog.Category', verbose_name='Категории')),
                ('gallery', models.ManyToManyField(related_name='posts', to='app_blog.Image', verbose_name='Галлерея')),
                ('preview', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='app_blog.image', verbose_name='Обложка')),
            ],
            options={
                'verbose_name': 'Пост',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date', models.DateTimeField(default=django.utils.timezone.now, verbose_name='Дата')),
                ('post', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app_blog.post', verbose_name='Новость')),
